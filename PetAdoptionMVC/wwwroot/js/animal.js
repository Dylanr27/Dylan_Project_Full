                ...
                },
                {
                    ...
                    "render": function (data) {
                        return `<div class="w-75 btn-group-md" role="group">
                                    ...
                                    <a href="/Admin/Animal/Upsert?id=${data}" class="btn btn-primary edit-btn crisp-text">
                                        <i class="bi bi-pencil-square crisp-text"></i> Edit
                                        </a>

                                    <a onClick=Delete('/Admin/Animal/Delete?id=${data}') class="btn btn-danger my-1 crisp-text">
